    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 text-center hover:shadow-xl transition">
                ...
                <p class="text-lg font-medium text-gray-600">Pesanan Baru Hari Ini</p>
                <p class="text-4xl font-bold text-green-600 mt-3">{{ $newOrdersToday }}</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 text-center hover:shadow-xl transition">
                ...
                <p class="text-lg font-medium text-gray-600">Penjualan Bulan Ini</p>
